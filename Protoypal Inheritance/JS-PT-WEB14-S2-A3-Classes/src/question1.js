...
class SavingsAccount extends Account {
  #interestRate;
  constructor(bank, balance, interestRate) {
    super(bank, balance);
...
class Cow extends Mammal {
  ...
  set MilkProduction(production) {
    this.#milkProduction = production;
  }
}
...
class Eagle extends Bird {
  ...
  constructor() {
    super(); // Call the constructor of the parent class (Bird)
    this.#wingspan = "Large"; // Initialize the private field with the default wingspan
  }
...
class Sparrow extends Bird {
  ...
  constructor() {
    super(); // Call the constructor of the parent class (Bird)
    this.#wingspan = "Small"; // Initialize the private field with the default wingspan
  }
